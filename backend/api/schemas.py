...
class TrainModelRequest(BaseModel):
    ...
    dataset_id: uuid.UUID = Field(..., description="Dataset version to train on")
...
class ValidationRequest(BaseModel):
    suite_name: str = Field(default="default_suite", description="Name of the expectation suite")
    generate_baseline: bool = Field(default=False, description="If true, generates a baseline from current data")
    target_column: Optional[str] = Field(default=None, description="Optional target column for ML")
...
# ============================================================================
# Datasets & Preprocessing Model (New)
# ============================================================================
...
class PreprocessingOptions(BaseModel):
    ...
    handle_missing: bool = Field(default=True, description="Fill missing values")
    remove_duplicates: bool = Field(default=True, description="Remove duplicate rows")
    encode_categorical: bool = Field(default=True, description="Auto-encode strings")
    scale_numerical: bool = Field(default=False, description="StandardScale features")
    remove_outliers: bool = Field(default=False, description="Remove IQR outliers")
    automated: bool = Field(default=False, description="Use Intelligent Automated Pipeline")
    target_column: Optional[str] = Field(default=None, description="Optional target column for intelligent split")
